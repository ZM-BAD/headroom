...
- [ ] Gemini: count search-source **site names** from DOM (no click interaction in v1; snippet text needs the source dialog which we won't auto-open)
...
| Gemini   | DOM `source-title` spans (site names) — snippets need the source dialog (P1, no auto-click)                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                    | ⚠️ names only  |
